...
API_ID = int(os.environ.get("API_ID", "24310647"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "8e043df44de667fff9ae6aabbcf186f3")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "8278569969"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://servicepetmania_db_user:z67e3VUswZfNxEgx@petmania.np5tw4n.mongodb.net/?retryWrites=true&w=majority&appName=petmania") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_NAME = os.environ.get("DB_NAME", "hunterBOt")
